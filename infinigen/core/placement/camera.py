...
from infinigen.core.placement.camera_utility import set_intrinsics_from_blender_params, set_lens_distortion, save_distortion_parameters, adjust_camera_sensor
...
def get_sensor_coords(cam, H, W, sparse=False):
    ...
    assert abs(sensor_width_in_m / sensor_height_in_m - W / H) < 0.1, (
        sensor_width_in_m,
        sensor_height_in_m,
        W,
        H,
    ...
    for view, cam_rig in zip(base_views, cam_rigs):
        ...
        for r in cam_rig.children:
            for c in r.children:
                ...
                c.data.lens = props.focal_length
