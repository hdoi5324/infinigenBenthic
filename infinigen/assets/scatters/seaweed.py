...
def apply(obj, scale=1, density=1., n=5, selection=None, **kwargs):
    ...
    factories = [SeaweedFactory(np.random.randint(1e5+444)) for i in range(n_species)]
    ...
    scatter_obj = scatter_instances(
        ...
        vol_density=U(2, 10), min_spacing=0.1,
        scale=scale, scale_rand=U(0.1, 0.9), scale_rand_axi=U(0, 0.2),
        normal_fac=0.3,
        selection=selection)
